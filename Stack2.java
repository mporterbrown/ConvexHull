...
public class Stack2<Item> implements Iterable<Item> {
    ...
    public Item sneak_peek() {
        if (isEmpty() || first.next == null) throw new NoSuchElementException("Stack underflow");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stack.sneak_peek());

        for (String x : stack) System.out.println(x);
